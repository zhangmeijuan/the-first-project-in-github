...
import com.gome.pangu.trading.account.client.SafetyVerificationClient;


public class SafetyVerificationClientIsNeedVerifyPayPasswordAdapter extends IAdapter<SafetyVerificationClient> implements IConvert{

    @Resource
    SafetyVerificationClient safetyVerificationClient;
