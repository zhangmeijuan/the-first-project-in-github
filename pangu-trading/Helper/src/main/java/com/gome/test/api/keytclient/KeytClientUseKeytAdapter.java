...
import com.gome.pangu.trading.keyt.client.KeytClient;


public class KeytClientUseKeytAdapter extends IAdapter<KeytClient> implements IConvert{

    @Resource
    KeytClient keytClient;
