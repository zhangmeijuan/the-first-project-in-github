...
import com.gome.pangu.trading.account.client.VirtualAccountClient;


public class VirtualAccountClientUseVirtualAccountAdapter extends IAdapter<VirtualAccountClient> implements IConvert{
