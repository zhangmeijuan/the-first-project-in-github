...
import com.gome.pangu.trading.cart.client.ShoppingCartCheckClient;


public class ShoppingCartCheckClientUncheckItemByShopNOAdapter extends IAdapter<ShoppingCartCheckClient> implements IConvert{

    @Resource
    ShoppingCartCheckClient shoppingCartCheckClient;
