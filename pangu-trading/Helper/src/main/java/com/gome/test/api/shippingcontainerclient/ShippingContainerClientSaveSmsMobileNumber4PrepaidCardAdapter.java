...
import com.gome.pangu.trading.shipping.client.ShippingContainerClient;


public class ShippingContainerClientSaveSmsMobileNumber4PrepaidCardAdapter extends IAdapter<ShippingContainerClient> implements IConvert{

    @Resource
    ShippingContainerClient shippingContainerClient;
